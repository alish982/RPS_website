      ...
      <div className="bg-white rounded-lg p-8">
        <div className="flex mb-2">
          <div className="hover:text-blue-400">
            <Link href="/dashboard/unverified_company">
        ...
        {companyData ? (
          <div key = {companyData.id} className="md:grid-cols-2 gap-8">
            ...
            <div className="py-5">
              <label className="text-[#1E1E1E] text-xl font-bold">Documents</label>
            </div>
          ...
          <p className="text-center text-gray-600">No company data available</p>
            ...
            {console.log(companyData.dominant_influence)}
        ...
        <button
          onClick={() => setHandleConfirm(!handleConfirm)}
      ...
      {handleConfirm ? (
        <div>
          <div className="fixed inset-0 flex justify-center items-center bg-gray-500 bg-opacity-50 z-50">
            <div className="bg-white shadow-xl rounded-lg p-8 text-center w-80">
              <p className="text-xl font-semibold mb-4 text-[#3462B5]">Are you sure to approve the company?</p>
              {loadingApprove ? (
                <div className="flex justify-center items-center mt-20">
